...
## 💡 About Me
새로운 기술을 빠르게 익히고 실제 문제에 적용하는 과정에 몰입하는 **보안 솔루션 개발자**입니다. 
단순한 기능 구현을 넘어 **사용자 중심의 UI/UX 개선**과 **다양한 환경을 고려한 시스템 설계**에 관심이 많습니다. 혼자보다는 팀 단위의 협업을 통해 문제를 다각도로 바라보고 해결하는 것을 즐깁니다.

- 🔭 현재 프론트엔드(React, TypeScript)와 IoT, 디지털 포렌식, 사이버 보안 등 다양한 도메인을 넘나들며 시야를 넓히고 있습니다.
